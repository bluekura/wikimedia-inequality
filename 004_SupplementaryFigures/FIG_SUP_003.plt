...
x = 0.0
##PLOT!
set term pdfcairo dashed enhanced color size 6.75, 3.2 font "Helvetica, 14" 
#set term pngcairo enhanced color size 800,600 font "Helvetica, 14" 
set origin 0,0.5
unset log x
set key top right
set key font "Helvetica, 8"
set o './FIG_SUP_003.pdf'
set size 0.5,0.5
set multiplot
...
pl './data/Allwiki_output.all' u 5:3 notitle pt 6 lc rgb "#f36d20"
unset label 1
set origin 0.5,0.5
...
pl './data/Allwiki_output.all' u 5:4 notitle pt 6 lc rgb "#f36d20" 
unset label 2
...
pl './data/Allwiki_output.all' u 5:6 notitle pt 6 lc rgb "#f36d20" 
unset label 3
...
set ytic (1e03,1e05,1e07,1e09,1e11)


set label 4 "{/Helvetica-Bold d}" at screen 0.51,0.48
pl './data/Allwiki_output.all' u 5:7 notitle pt 6 lc rgb "#f36d20" 
unset label 4
